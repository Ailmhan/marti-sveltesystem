<script lang="ts">
	...
	function openAdminModal() {
		console.log('🔐 School Landing: openAdminModal called, current showAdminModal:', showAdminModal);
		console.log('🔐 School Landing: adminStore state:', $adminStore);
		showAdminModal = true;
		console.log('🔐 School Landing: showAdminModal set to:', showAdminModal);
	}

	function closeAdminModal() {
		console.log('🔐 School Landing: closeAdminModal called');
		showAdminModal = false;
	}

	onMount(() => {
		console.log('🏫 School Landing Layout mounted, authStore:', {
		...
		if (!$authStore.schoolData && $authStore.token) {
			console.log('🏫 Loading school data in landing layout...');
...
<div class="school-landing-layout">
	<!-- Навбар школы -->
