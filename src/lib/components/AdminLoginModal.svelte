<script lang="ts">
	...
	$: {
		console.log('AdminLoginModal: open prop changed to:', open);
	}
			...
			<form on:submit={handleSubmit} class="modal-form">
				<div class="modal-body">
					...
					<div class="admin-info">
						...
						Для получения прав администратора введите ваши учетные данные.
						Режим администратора останется активным до выхода из системы.
					</p>
					</div>
